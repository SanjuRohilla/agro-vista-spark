  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-glass-border glass-card text-foreground hover:bg-glass-strong backdrop-blur-lg",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-md hover:shadow-lg",
        ghost: "hover:bg-glass-strong hover:text-foreground backdrop-blur-sm",
        link: "text-primary underline-offset-4 hover:underline",
        glass: "glass-card border border-glass-border text-foreground hover:bg-glass-strong backdrop-blur-xl",
        gradient: "gradient-primary text-primary-foreground hover:opacity-90 shadow-lg hover:shadow-[var(--shadow-glow)]",
      },
      size: {
